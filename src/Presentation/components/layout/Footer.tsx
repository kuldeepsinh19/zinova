        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600 max-w-md leading-relaxed">
              AI-Powered Marketing for Indian Startups. Generate professional
              marketing visuals at the lowest cost. Transform your product
              photos into stunning, studio-quality images.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Zinnova. All rights reserved.
            </p>
